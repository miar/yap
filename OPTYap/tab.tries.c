...
static inline void insert_bucket_chain(ans_node_ptr *, ans_node_ptr, ans_node_ptr, long, int USES_REGS);
static inline void insert_bucket_array(ans_node_ptr *, ans_node_ptr, long USES_REGS);
