 ...
 *                            compatibility stuff                              *
 *******************************************************************************/
#define LFTH_NODE_ENTRY(X)                             TrNode_entry(X)
#define LFTH_NrLowTagBits                              NumberOfLowTagBits /* 0 (zero) if none */
#define LFTH_USES_REGS                                 USES_REGS          /* BLANC if no TabMalloc */   
#define LFTH_PASS_REGS                                 PASS_REGS          /* BLANC if no TabMalloc */ 
#define LFTH_NODE_ENTRY_STR                            Term
/*******************************************************************************
 *                            LFTH macros                                      *
 *******************************************************************************/
...
#define V04_SHIFT_ENTRY(ENTRY, N_SHIFTS)               ((ENTRY) >> ((SHIFT_SIZE * (N_SHIFTS)) + LFTH_NrLowTagBits))
...
#define V04_IS_EQUAL_ENTRY(X, T)                       (LFTH_NODE_ENTRY(X) == T)
...
#define LFTH_BOOL_CAS(PTR, OLD, NEW)                    __sync_bool_compare_and_swap((PTR), (OLD), (NEW))
