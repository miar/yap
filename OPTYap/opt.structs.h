...
double  walltime_by_thread[WALLTIME_BY_THREAD_NR_RUNS][WALLTIME_BY_THREAD_MAX_THREADS];
...
struct global_pages {
  ...
  struct global_page_entry consumer_trie_hash_buckets_pages;
#endif
...
#endif
#if defined(THREADS_FULL_SHARING_FTNA_3)
  struct local_page_entry consumer_trie_hash_buckets_pages;
#endif
...
#define GLOBAL_pages_cons_trie_hash_buckets     (GLOBAL_optyap_data.pages.consumer_trie_hash_buckets_pages)
...
#define LOCAL_pages_cons_trie_hash_buckets (LOCAL_optyap_data.pages.consumer_trie_hash_buckets_pages)
...
#define REMOTE_pages_cons_trie_hash_buckets(wid) (REMOTE(wid)->optyap_data_.pages.consumer_trie_hash_buckets_pages)
