...
/* only one min/max  int/float term. Do not try with more terms. more terms would 
give error in DepFr_init_sg_trie_min_max_field macro for example. 
Activate THREADS_NO_SUBGOAL_TRIE.*/
